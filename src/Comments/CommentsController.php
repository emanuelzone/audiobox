...
class CommentsController extends \Anax\MVC\CControllerBasic
{
    ...
    public function addCommentAction($text, $answerId = null, $questionId = null)
    {
        ...
        try {
            ...
            $this->form->AddOutput("<p class='warning'><i class='fa fa-check'></i> >Kommentaren kunde inte sparas</p>");
    ...
    private function callbackSuccess($form)
    {
            ...
            $form->AddOUtput("<p class='success'><i class='fa fa-check'></i> Check!</p>");
            $this->redirectTo();
    }
    ...
    {
            // What to do if the form was submitted?
            $form->AddOUtput("<p class='warning'><i class='fa fa-check'></i> Ooops, something went wrong!</p>");
            $this->redirectTo();
    }
